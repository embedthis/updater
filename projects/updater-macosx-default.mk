...
$(BUILD)/obj/main.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/main.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) $(IFLAGS) "-Isrc" "-Isrc/osdep" "-I/opt/homebrew/include" "src/main.c"
...
$(BUILD)/obj/updater.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/updater.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-Isrc" "-Isrc/osdep" "-I/opt/homebrew/include" "src/updater.c"
...
$(BUILD)/bin/updater: $(DEPS_8)
	...
	$(CC) -o "$(BUILD)/bin/updater" -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "-L/opt/homebrew/lib" "$(BUILD)/obj/main.o" $(LIBPATHS_8) $(LIBS_8) $(LIBS_8) $(LIBS) "-lssl" "-lcrypto" 

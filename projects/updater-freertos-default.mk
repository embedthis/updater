#
#   updater-freertos-default.mk -- Makefile to build EmbedThis Updater for freertos
#

NAME                  := updater
VERSION               := 1.1.2
PROJECT               := updater-freertos-default
PROFILE               ?= dev
...
ME_CONFIGURE          ?= \"me -d -q -platform freertos-arm-default -configure . -gen make\"
ME_CONFIGURED         ?= 1
ME_DEBUG              ?= 1
ME_DEPTH              ?= 1
...
$(BUILD)/bin/updater: $(DEPS_8)
	...
	$(CC) -o "$(BUILD)/bin/updater" $(LIBPATHS) "-L/opt/homebrew/lib" $(INPUT) "$(BUILD)/obj/main.o" $(LIBPATHS_8) $(LIBS_8) $(LIBS_8) $(LIBS) "-lcrypto" "-lssl" $(LIBS) "-lcrypto" "-lssl" 

 ...
 */
static int createTestScript(cchar *path)
{
    FILE *fp;
...
static void test_null_host(void)
{
    ...
    rc = update(NULL, testProduct, testToken, testDevice, testVersion, NULL, testFile, NULL, 0);
    ttrue(rc == -1);
}
...
static void test_null_product(void)
{
    ...
    rc = update(testHost, NULL, testToken, testDevice, testVersion, NULL, testFile, NULL, 0);
    ttrue(rc == -1);
}
...
static void test_null_token(void)
{
    ...
    rc = update(testHost, testProduct, NULL, testDevice, testVersion, NULL, testFile, NULL, 0);
    ttrue(rc == -1);
}
...
static void test_null_device(void)
{
    ...
    rc = update(testHost, testProduct, testToken, NULL, testVersion, NULL, testFile, NULL, 0);
    ttrue(rc == -1);
}
...
static void test_null_version(void)
{
    ...
    rc = update(testHost, testProduct, testToken, testDevice, NULL, NULL, testFile, NULL, 0);
    ttrue(rc == -1);
}
...
static void test_null_path(void)
{
    ...
    rc = update(testHost, testProduct, testToken, testDevice, testVersion, NULL, NULL, NULL, 0);
    ttrue(rc == -1);
}
...
static void test_null_properties(void)
{
     ...
     */
    rc = update(testHost, testProduct, testToken, testDevice, testVersion, NULL, testFile, NULL, 0);
    /*
...
static void test_oversized_host(void)
{
    ...
    rc = update(longHost, testProduct, testToken, testDevice, testVersion, NULL, testFile, NULL, 0);
    ttrue(rc == -1);
}
...
static void test_oversized_properties(void)
{
    ...
    rc = update(testHost, testProduct, testToken, testDevice, testVersion, longProps, testFile, NULL, 0);
    ttrue(rc == -1);
}
...
static void test_http_host(void)
{
     ...
     */
    rc = update("http://api.embedthis.com", testProduct, testToken, testDevice, testVersion, NULL, testFile, NULL, 0);
    ttrue(rc == -1);
}
...
static void test_empty_host(void)
{
    ...
    rc = update("", testProduct, testToken, testDevice, testVersion, NULL, testFile, NULL, 0);
    ttrue(rc == -1);
}
...
static void test_empty_device(void)
{
    ...
    rc = update(testHost, testProduct, testToken, "", testVersion, NULL, testFile, NULL, 0);
    ttrue(rc == -1);
}
...
static void test_empty_version(void)
{
    ...
    rc = update(testHost, testProduct, testToken, testDevice, "", NULL, testFile, NULL, 0);
    ttrue(rc == -1);
}
...
static void test_tmp_path_warning(void)
{
     ...
     */
    rc = update(testHost, testProduct, testToken, testDevice, testVersion, NULL, "/tmp/test.bin", NULL, 0);
    ttrue(rc == -1);
}
...
static void test_invalid_file_path(void)
{
    ...
    rc = update(testHost, testProduct, testToken, testDevice, testVersion, NULL,
                "/nonexistent/path/to/file.bin", NULL, 0);
    ttrue(rc == -1);
}
...
static void test_valid_properties(void)
{
    ...
    rc = update(testHost, testProduct, testToken, testDevice, testVersion,
                "\"model\":\"pro\",\"region\":\"us-west\"", testFile, NULL, 0);
    /*
...
static void test_verbose_mode(void)
{
    ...
    rc = update(testHost, testProduct, testToken, testDevice, testVersion, NULL, testFile, NULL, 1);
    /*
...
static void test_special_chars_device(void)
{
    ...
    rc = update(testHost, testProduct, testToken, "device-001_test.v2", testVersion, NULL, testFile, NULL, 0);
    ttrue(rc == -1);
}
...
static void test_semver_formats(void)
{
     ...
     */
    rc = update(testHost, testProduct, testToken, testDevice, "1.2.3", NULL, testFile, NULL, 0);
    ttrue(rc == -1);

    rc = update(testHost, testProduct, testToken, testDevice, "1.2.3-beta", NULL, testFile, NULL, 0);
    ttrue(rc == -1);

    rc = update(testHost, testProduct, testToken, testDevice, "1.2.3-beta.1+build.123", NULL, testFile, NULL, 0);
    ttrue(rc == -1);
}
...
static void test_long_token(void)
{
    ...
    rc = update(testHost, testProduct, longToken, testDevice, testVersion, NULL, testFile, NULL, 0);
    /*
...
static void test_nonexistent_script(void)
{
    ...
    rc = update(testHost, testProduct, testToken, testDevice, testVersion, NULL,
                testFile, "/nonexistent/script.sh", 0);
    /*
